...
export const DogData = [
  ...
  },
  {
    ...
    path: '/beagle',
    origin: 'England',
    colors: ['Tri-color, Lemon & White, White & Tan, Chocolate Tri, Orange & White, Red & White, and White & Chocolate'],
    description:
  ...
  },
  {
    ...
    path: '/basset',
    origin: 'United Kingdom',
    colors: ['Tri-color, Lemon & White, Black & White, Red & White, Black & Brown, and White & Chocolate'],
    description:
